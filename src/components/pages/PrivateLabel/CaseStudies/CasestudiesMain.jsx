...
function CaseStudiesItem({ ...props }) {
    ...
    useEffect(() => {
        ...
        animate(item.querySelector('.private-kasestu-main-item-bot-img img'), { opacity: 0, scale: .4, transformOrigin: "left bottom" }, { duration: 0 })
        ...
        inView(item, () => {
            timeline(sequence).finished.then(() => {
                ...
                title.revert()
                readMore.revert()
                item.querySelector('.private-kasestu-main-item-bot-img img').removeAttribute('style')
    ...
    return (
        <a href={`/kase-studies/${props.data.uid}`} className="keen-slider__slide private-kasestu-main-item bg-light" ref={itemRef} data-cursor="ext">
            ...
            <div className="private-kasestu-main-item-bot">
                <div className="private-kasestu-main-item-bot-img">
                    <img src={props.data.data.images[0]?.image_item.url} alt={props.data.data.images[0]?.image_item.alt} className="img img-fill" />
                </div>
                <div className="txt txt-18 txt-bold private-kasestu-main-item-bot-readmore">
                    <span>Read more</span>
